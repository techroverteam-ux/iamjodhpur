...
export const metadata = {
  ...
  description: 'All India Test Series for practice',
};
      ...
      <div className="breadcrumb-section">
        <div className="course-container">
          <div className="breadcrumb-text">
            <a href="/">Home</a> &gt; <a href="/courses">Our Courses</a> &gt; All India Test Series (AITS)
          </div>
        </div>
      </div>
      ...
      <div className="course-container">
        <div className="course-grid">
          <div className="course-content">
            <h2>All India Test Series (AITS)</h2>
            
            <h3>Features</h3>
            <p>Regular test series for assessment and practice to help students prepare for competitive exams.</p>
          </div>
