  ...
  useEffect(() => {
    ...
    const fetchBanner = async () => {
      try {
        ...
        if (data.banners?.facilities) {
          setBannerImage(data.banners.facilities)
        }
      } catch (error) {
    ...
    <>
      <style jsx global>{`
        ...
        @media (max-width: 768px) {
          ...
          .facility-card .flex[style*="row-reverse"] {
            flex-direction: column !important;
          }
          .facility-card img {
            width: 100% !important;
      ...
      {bannerImage ? (
        <div style={{position: 'relative', width: '100%', overflow: 'hidden'}}>
          <img src={bannerImage} alt="Facilities" style={{width: '100%', height: '400px', objectFit: 'cover', display: 'block'}} />
          <div style={{position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(255, 255, 255, 0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <h1 style={{color: '#1B5A96', fontSize: '2.8rem', fontWeight: '900', textShadow: '2px 2px 4px rgba(0,0,0,0.3)'}}>Our Facilities</h1>
          </div>
        </div>
      ) : (
            ...
            <div className="facility-card animate-zoom">
              <div className="flex items-center">
                <div style={{marginRight: '30px'}}>
                  <img src="/Tranasport.png" alt="Transport Facility" style={{width: '280px', height: '200px', objectFit: 'cover', borderRadius: '15px'}} />
                </div>
                <div style={{flex: 1}}>
            ...
            <div className="facility-card animate-zoom">
              <div className="flex items-center" style={{flexDirection: 'row-reverse'}}>
                <div style={{marginLeft: '30px'}}>
                  <img src="/hostel.jpeg" alt="Hostel Facility" style={{width: '280px', height: '200px', objectFit: 'cover', borderRadius: '15px'}} />
                </div>
                <div style={{flex: 1}}>
                  <h3 className="text-3xl md:text-4xl font-bold mb-2" style={{color: 'var(--primary-medium)'}}>
                    <span style={{fontSize: '18px', marginRight: '6px'}}>✦</span>
